...
from devcon_win import Android_ADB_Interface                   #For Drivers Management
...
#After ADB&Fastboot tool has been installed, we proceed on getting device ready
os.system('cls')
SetupDeviceForUSBCommunication()
os.system('cls')
...
#Install USB Drivers
Check_ADB = Android_ADB_Interface()
if "The device has the following problem:" in Check_ADB:
    print('Windows Driver Signature Verification hasn\'t been disabled!')
    print('Disabling...')
    os.system('bcdedit /set testsigning on')
    print('The computer will reboot')
    sleep(5)
    os.system('reboot')
